    ...
    <div className={wrapperClass}>
      ...
      <div className={isModal ? "mb-6" : "mb-8"}>
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 id="modal-boutique-title" className={`font-bold text-gray-200 ${isModal ? "text-2xl" : "text-3xl"}`}>
              Boutique
            </h1>
          ...
          {CREDIT_PACKAGES.map((pkg) => (
            ...
            >
              ...
              <div className="text-center mb-6">
                ...
                <div className="text-sm text-gray-400">{pkg.pricePerUnit}</div>
              </div>
              <button
                onClick={() => {
          ...
          {SUBSCRIPTION_PLANS.map((plan) => (
            ...
            >
              ...
              <div className="text-center mb-6">
                ...
                <div className="mb-2 text-sm text-gray-300">Jusqu'à 30 vidéos / mois</div>
                ...
                {plan.savings && (
                  <div className="text-sm text-emerald-400 font-medium mt-2">{plan.savings}</div>
                )}
              </div>
